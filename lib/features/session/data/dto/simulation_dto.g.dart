...
SimulationDto _$SimulationDtoFromJson(Map<String, dynamic> json) =>
    SimulationDto(
      ...
      overallConversionRate: (json['overall_conversion_rate'] as num).toInt(),
      overallDropoutRate: (json['overall_dropout_rate'] as num).toInt(),
...
AgentDto _$AgentDtoFromJson(Map<String, dynamic> json) => AgentDto(
  ...
  statusQuoTendency: (json['status_quo_tendency'] as num).toInt(),
  contextAttributes: ContextAttributesDto.fromJson(
    json['context_attributes'] as Map<String, dynamic>,
  ),
...
Map<String, dynamic> _$AgentDtoToJson(AgentDto instance) => <String, dynamic>{
  ...
  'context_attributes': instance.contextAttributes,
  'trigger_sensitivities': instance.triggerSensitivities,
  'lifestyle_notes': instance.lifestyleNotes,
};

ContextAttributesDto _$ContextAttributesDtoFromJson(
...
Map<String, dynamic> _$ContextAttributesDtoToJson(
  ContextAttributesDto instance,
) => <String, dynamic>{
...
OceanDto _$OceanDtoFromJson(Map<String, dynamic> json) => OceanDto(
  openness: (json['openness'] as num).toInt(),
...
StageInsightDto _$StageInsightDtoFromJson(Map<String, dynamic> json) =>
    StageInsightDto(
      stageName: json['stage_name'] as String,
      dropoutRate: (json['dropout_rate'] as num).toInt(),
      delayRate: (json['delay_rate'] as num).toInt(),
