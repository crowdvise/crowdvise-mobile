...
class JourneyModal extends StatefulWidget {
  const JourneyModal({super.key, this.stageModel});
  final JourneyStageModel? stageModel;
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Gap(16),
                Text(
                  widget.stageModel != null ? 'Edit Stage' : 'Add a new stage',
                ...
                const Gap(32),
                Button(
                  title: widget.stageModel != null
                      ? 'Update Stage'
                      : 'Add Stage',
                  onPressed: () {
                    if (widget.stageModel != null) {
                      provider.updateStage(widget.stageModel!.order);
                    } else {
                      provider.addStage();
                    }
                    context.pop();
...
class DeleteModal extends StatefulWidget {
  const DeleteModal({super.key, required this.order});
  final int order;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Button(
                        ...
                        onPressed: () {
                          provider.deleteStage(widget.order);
                          context.pop();
                        },
                      ),
                    ),
